...
export const PLANET_MAPS: Record<string, PlanetMapData> = {
  profile: {
    ...
    layout: [
      WALL_ROW,
      'WWWGGWWGWWGGGGGGGGGGGGGGGGGGGGGG', // Row 2
      'WWWGGWWGWWGGGGGGGGGGGGGGGGGGGGGG', // Row 2
      'WWGGGWGGWWGGGGGGGGGGGGGGGGGGGGGW', // Row 3
      'WWGGGGGGWWGGGGGGGGGGGGGGGGGGGGGW', // Row 4
      'WGGGGGGGWWWWGGGGGGGWGGGGGGGGGGGG', // Row 5
      'WGGGGGGGGWWGGGGGGGWGGGGGGGGGGGGW', // Row 6
      'WGGGGGGGGWWGGGGGGGWWGGGGGGGGGGGW', // Row 7
      'WWWWWWWGGGGGGGWWWGGGWWGGGGGGGGGW', // Row 8
      'WWWWWWWGGGGGGWWWWWWWWWWGGGGGGGGW', // Row 9
      'WWWWWWWGGGGGGGWWWWWWWWWWGGGGGGGG', // Row 10
      'WGGGGGGGGGGGGGWWWWWWWWWWGGGGGGGG', // Row 11
      'WGGGGGGGGGGGGWWWWWWWWWWGGGGGGGGW', // Row 12
